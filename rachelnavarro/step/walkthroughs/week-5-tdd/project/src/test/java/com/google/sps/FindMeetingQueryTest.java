...
public final class FindMeetingQueryTest {
  ...
  public void optionalAttendeeIsConsidered() {
    // Add an optional attendee C who has an event between 8:30 and 9:00. Now only the early 
    // and late parts of the day should be returned.
    //
    // Events  :       |--A--|     |--B--|
    //                       |--C--|
    // Day     : |-----------------------------|
  ...
  @Test
  public void optionalAttendeeHasJustEnoughRoom() {
    // Add an optional attendee B who has an event between 8:30 and 8:45. The optional attendee  
    // should be ignored since considering their schdule would result in a time slot smaller than 
    // the requested time.
    //
    // Events  : |--A--|     |----A----|
    //                 |-B-|
