...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void optionalAttendeeIsUnavailable() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times.
    //
    // Events  :       |--A--|     |--B--|
  ...
  @Test
  public void justEnoughRoomDespiteOptionalAttendee() {
    // Have one mandatory person, but make it so that there is just enough room at one point in the day
    // to have the meeting. The optional attendee should be ignored since considering their schedule 
  ...
  public void allAttendeesOptional() {
    // All attendees are optional, and have gaps in their schedule that align. We should see these
    // gaps identified and returned.
    //
    // Events  :       |--A--|     |--B--|
    // Day     : |-----------------------------|
    // Options : |--1--|     |--2--|     |--3--|
  ...
  @Test
  public void allAttendeesOptionalAndUnavailable() {
    // All attendees are optional, and have no suitable gaps in their schedules. We should see there
    // are no options.
    //
    // Events  : |--------------A--------------|
    //           |--------------B--------------|
