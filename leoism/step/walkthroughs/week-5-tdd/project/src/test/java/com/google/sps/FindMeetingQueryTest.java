...
public final class FindMeetingQueryTest {
  ...
  public void optionalCannotAttend() {
    // Have each person have different events. We should see three options because
    // each person has split the restricted times. Since optional does not have time,
    // they are ignored.
    //
    // Events  :       |--A--|     |--B--|
    // Optional: |--------------C--------------|
    ...
    MeetingRequest request = new MeetingRequest(
        Arrays.asList(PERSON_A, PERSON_B), DURATION_30_MINUTES);
  ...
  public void optionalCanAttend() {
    ...
    // each person has split the restricted times. Optional attendee has time to
    // attended, so book all three slots and leave two slots open.
    //
    // Events  :       |--A--|     |--B--|
    // Optional:             |--C--|
    // Day     : |-----------------------------|
  ...
  public void justEnoughRoomOptional() {
    ...
    // in the day to have the meeting. The optional attendee should be ignored since
    // considering their schedule would result in a time slot smaller than the requested
    // time.
    //
    // Events  : |--A--|    |---A---|
    // Optional:       |B|
  ...
  @Test
  public void allAreOptionalWithGaps() {
    // Have two optional people with gaps in their schedules. The gaps should
    ...
    Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartEnd(TimeRange.START_OF_DAY, TIME_0830AM, false),
            Arrays.asList(PERSON_A)),
        new Event("Event 2", TimeRange.fromStartEnd(TIME_1000AM, TIME_1100AM, false), Arrays.asList(PERSON_B)));
  ...
  @Test
  public void allAreOptionalWithNoGaps() {
    // Have two optional people with no gaps in their schedules. The whole day
    // should be returned since the optional attendees cannot be accommodated 
    // and the mandortory ones (0) are free all day.
    //
    // Optional: |----------A----------|
    // Optional: |----------B----------|
    // Day     : |---------------------|
  ...
  @Test
  public void overlappedOptionalWithGap() {
    // Have two optional people that have overlapping meetings. The time 
    // before and after the the peoples meetings should be returned
    //
    // Optional: |--A--|
    // Optional:    |--B--|
    // Day     : |---------------------|
